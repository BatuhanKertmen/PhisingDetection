...
# PYTHON
DOMAINS_RAW_DIR = os.path.join(WORKING_DIR, "domains", "raw")
DOMAINS_VALID_DIR = os.path.join(WORKING_DIR, "domains", "valid")
CRAWLER_DIR = os.path.join(WORKING_DIR, "crawlers")
WEBSITES_DIR = os.path.join(WORKING_DIR, "websites")
...
# DRIVERS
DRIVER_DIR = os.path.join(WORKING_DIR, "drivers")
